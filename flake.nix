{
  ...
  inputs = {
    ...
    tree-sitter-javascript = { url = "github:tree-sitter/tree-sitter-javascript?rev=bc2eb3994fd7cc605d27a32f9fcbee80bbb57f6d"; flake = false; };
    ...
    tree-sitter-typescript = { url = "github:tree-sitter/tree-sitter-typescript?rev=d598c96714a2dc9e346589c63369aff6719a51e6"; flake = false; };
